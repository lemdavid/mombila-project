          ...
          <a href="<?php echo $link; ?>" style="text-decoration: none;">
            <div class="media table-content-cell">
                ...
                <div class="media-body">
                  <h4 class="media-heading" style="font-size:48px;"><?php echo $Guide_First_name.' '.$Guide_Last_name.' '.$Notification_action ?></h4>
                  <span class="notification-location" style="font-size:48px;"> <?php echo $Notification_Reference ?> </span>
                </div>
              </div>
            <div class="notification-time table-content-cell" style="font-size:40px;"><?php echo $Notification_date ?></div> </a>

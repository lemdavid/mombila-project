...
function location_displayImage(e) {
 ...
 <div id="location_image_form" style="display:none;">
                <div style="font-size:44px; margin-bottom:2%; margin-top:5%; width:70%; float:left;">
                    <center><b>Please Upload A Tourist Location</b></center></div>

                  <div style="font-size:54px; margin-bottom:2%; margin-top:5%; width:20% float:left;">
              ...
              <p id="location_error" style="color:red; font-size:44px;"></p>

         ...
         <div class="list-group-item table-content">
            <div class="media table-content-cell">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><?php echo $Guide_First_name.' '.$Guide_Last_name.' Requesting For Profile Details' ?></h4>
                  <span class="notification-location">Profile Details Including Phone Number, Email, Address Etc... </span>
                </div>

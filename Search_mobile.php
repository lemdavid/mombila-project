...
$profile_link = $profile_images;
    ...
    <div id="tourist_guide_container" style="width:100%; font-size:40px; float:left;">Tourist Guide since  '.$Guide_year.'
        <br> Number Of Locations '.$number_of_location.'
    </div> </div>';
   echo '</div> </a>';

   echo '<div id="tourist_guide_connect_container" style="width:100%; margin-top:5%;  float:left;">';

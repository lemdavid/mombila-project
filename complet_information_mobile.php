...
<div style="font-size:54px; margin-bottom:2%;"><center><b>Complete Your Registration</b></center></div>
<div id="complete_form_error" style="font-size:48px; margin-bottom:2%; color:red; text-align:center;"></div>
<div class="container">
    <div class="content">
            <form>
            ...
            <div style="width:100%; margin-bottom:5%; font-size:44px;">Name Must Be The Same In Government Issued Id Card</div>
              <div style="width:100%; font-size:44px;">Date Of Birth</div>
            <div class="beside">
...
<div style="font-size:54px; margin-bottom:5%; width:100%; float:left;"><center><b>Upload Your Profile Picture</b></div>
                <p id="profile_error" style="font-size:48px; margin-bottom:2%; color:red; text-align:center;"></p>
...
<div style="font-size:54px; margin-bottom:2%; margin-top:5%;"><center><b>Please Select Your Option</b></center></div>
...
<div id="Add_hosting_location">
    <?php include 'add_location_mobile.php'; ?>
</div>

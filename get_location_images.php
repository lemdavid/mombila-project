...
<img src="cancel_icons.png" width="30px" style="margin-left:90%; margin-top:2%;" id="close_image_location"></img>
       ...
       for ( $i = 0; $i < $database_id ; $i++)
    {
      $image =  $image_root.$database_ids.$image_group.$i.'.jpg';
            ...
            echo ' <li id="slide'.$i.'" tabindex="-1">
					<img src="'.$image.'" alt="Slide '.$i.' Image" height="400px"/>
					<p>'.$location_name.'</p>
				</li>';
...
?>
		...
		<div class="thumb-container__wrap">
			<a href="#prev" class="prev" style="color:white; font-size:54px;">&laquo;</a>
          ...
          for ( $i = 0; $i < $database_id ; $i++)
    {
      $image =  $image_root.$database_ids.$image_group.$i.'.jpg';
          ...
          ?>
			...
			<a href="#next" class="next" style="color:white; font-size:54px;">&raquo;</a>
		</div>
	</div>
</div>
  <script>
